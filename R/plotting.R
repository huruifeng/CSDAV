...
plot.classification <- function(id,counts) {
  ...
  p1 <- ggplot2::ggplot(tmp1, ggplot2::aes_string(x="factor(1)", y="Freq", fill="Category")) +
    ...
    ggplot2::xlab("") +
    ggplot2::ylab("")
  # ggplot2::scale_fill_manual(name="Category",values=c(All="gray50",Essential="#F8766D",Nonessential="#00BFC4",Nontargeting="blue"))
  p2 <- ggplot2::ggplot(tmp2, ggplot2::aes_string(x="factor(1)", y="Freq", fill="Category")) +
    ...
    ggplot2::xlab("") +
    ggplot2::ylab("")
  # ggplot2::scale_fill_manual(name="Category",values=c(All="gray50",Essential="#F8766D",Nonessential="#00BFC4"))
...
plot.sizes <- function(library, counts_mat){
  ...
  # tmp2$Category <- factor(tmp2$Category, levels=c("Essential","SEED","Nonessential","Nontargeting","All"))
  ...
  # ggplot2::scale_fill_manual(name="Category",values=c(All="gray50",Essential="#F8766D",Nonessential="#00BFC4",SEED="red",Nontargeting="blue"))
  return(p1)
}
...
plot.depths <- function(counts){
  ...
  # tmp3$Category <- factor(tmp3$Category, levels=c("Essential","SEED","Nonessential","Nontargeting","All"))
...
plot.correlation <- function(counts){
  ...
  return(gplots::heatmap.2(tmp1, cexRow=1, cexCol=1, margins=c(15,15), #cexRow and cexCol change the font size
            ...
            col=grDevices::colorRampPalette(c("yellow","red"))))
}
...
plot.distributions <- function(logged,anno,formula){
  ...
  p1 <- ggplot2::ggplot(my_data[my_data$Category!="All",],ggplot2::aes_string("Log2",color="Category")) +
    ggplot2::theme(
      legend.position="top",
      legend.title=ggplot2::element_blank(),
      panel.background=ggplot2::element_blank(),
    ...
    ggplot2::geom_line(data=my_data[my_data$Category=="All",],stat="density",linetype="dashed",size=2) +
    ggplot2::ylab("Density") +
    ggplot2::facet_grid(stats::as.formula(formula)) +
    ggplot2::scale_fill_discrete(guide=FALSE)
    # ggplot2::scale_color_manual(name="Category",values=c(All="gray50",Essential="#F8766D",Nonessential="#00BFC4",SEED="red",Nontargeting="blue"))
  print(p1)
}
